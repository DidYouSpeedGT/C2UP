...
raw = """
\033[0;36m				Kiba\033[0;34mTools
\033[0;36m				Kiba\033[0;34mTools
\033[0;36m			        Kiba\033[0;34mTools
\033[0;36m                            Hosted By :\033[0;34m Kiba
...
\033[0;36m                              Kiba\033[0;34mTools		        
\033[0;36m                              Kiba\033[0;34mTools
\033[0;36m                            Hosted By :\033[0;43m Kiba
...
def main():
	...
	while True:
		...
		sys.stdout.write("\x1b]2;[-] Lezovsky C2 | Api Connected [5] | Backup Server [1] | Online User [2] | Admin: [Kiba,Kent] | POWER : {}% [UNSTABLE]\x07".format (powerran))
		sin = input("\033[0;36m{}\033[0;34m@[EclipseC2]\033[36m--> \033[0;31m".format(nicknm)).lower()
		sinput = sin.split(" ")[0]
		if sinput == "clear":
			os.system ("cls")
			print (banner)
